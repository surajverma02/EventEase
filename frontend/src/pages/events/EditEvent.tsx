  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (bannerFile) {
        ...
        await eventsAPI.uploadBanner(id!, formDataBanner);
      }
  ...
  if (loading) {
    return (
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-xl border border-[#E2E8F0] p-8 animate-pulse">
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-xl border border-[#E2E8F0] overflow-hidden">
        <div className="p-6 border-b border-[#E2E8F0]">
          <h1 className="text-2xl font-semibold text-[#0F172A]">Edit Event</h1>
          <p className="text-[#64748B] mt-1">Update event details</p>
        </div>
